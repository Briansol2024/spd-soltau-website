...
export function datenschutzPage(d) {
  ...
  return legal('Rechtliches', 'Datenschutz', `
    ...
    <h2>5. Informieren &amp; Mitreden (Anliegen, Fragen, Abstimmungen)</h2>\r\n    <p>Auf den Seiten unter „Informieren &amp; Mitreden“ können Sie ohne Anmeldung teilnehmen: ein Anliegen mit „Betrifft mich auch“ unterstützen, eine Frage stellen (auf Wunsch anonym) und bei kleinen Abstimmungen mitmachen. Dabei speichern wir <b>keine Namen, keine E-Mail-Adressen und keine IP-Adressen</b>, sondern nur Ihre Auswahl bzw. Ihren Text sowie eine zufällige Gerätekennung. Diese Kennung ist eine Zufallszahl ohne Bezug zu Ihrer Person; sie sorgt dafür, dass eine Stimme je Gerät gezählt wird. Wenn Sie in einem Frageformular freiwillig Ihren Namen oder Ihre E-Mail-Adresse angeben, verarbeiten wir diese nur, um Ihnen zu antworten.</p>\r\n    <p>Damit die Seite weiß, was Sie schon beantwortet haben, legt Ihr Browser dazu kleine Einträge auf Ihrem Gerät ab (kein Cookie, sondern der lokale Speicher des Browsers): die zufällige Gerätekennung sowie Vermerke wie „diese Abstimmung ist erledigt“. Diese Einträge sind für die von Ihnen gewünschte Funktion erforderlich (§ 25 Abs. 2 Nr. 2 TDDDG); eine Einwilligung ist dafür nicht nötig. Sie können sie jederzeit in den Browsereinstellungen löschen – dann ist lediglich der Hinweis weg, dass Sie schon abgestimmt haben.</p>\r\n    <p>Ergebnisse veröffentlichen wir nur als Summe (z. B. „18 Stimmen“), nie einzeln. Fragen veröffentlichen wir mit Antwort erst, wenn Sie dem zugestimmt haben. Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO (Interesse an einem Meinungsbild aus der Stadt) bzw. lit. a, soweit Sie einer Veröffentlichung zustimmen. Beiträge löschen wir, sobald sie erledigt sind, spätestens nach zwölf Monaten.</p>\r\n    <h2>6. Newsletter</h2>
    ...
    <h2>7. Mitgliederbereich und App</h2>
    ...
    <h2>8. Inhalte der Stadt Soltau, Instagram und externe Links</h2>
    ...
    <h2>9. Schriften, Karten, Cookies</h2>
    <p>Schriften werden von unserem eigenen Server geladen (keine Google Fonts). Wir binden keine Kartendienste und keine Social-Media-Plugins ein; das Luftbild auf der Kontaktseite ist ein bei uns gespeichertes Bild (Quelle: Landesamt für Geoinformation und Landesvermessung Niedersachsen, CC BY 4.0), der Kartenlink führt erst nach Klick zu OpenStreetMap. Technisch notwendige Einträge im lokalen Speicher Ihres Browsers gibt es nur an drei Stellen: im Mitgliederbereich (siehe 7), bei „Informieren &amp; Mitreden“ (siehe 5) und für den Passwortschutz der Testversion. Werbe- oder Tracking-Cookies setzen wir nicht, auch keine Cookies zur Wiedererkennung. Ein Cookie-Banner ist daher nicht erforderlich.</p>
    <p><b>Reichweitenmessung ohne Cookies:</b> Um zu wissen, welche Seiten gelesen werden, zählen wir Seitenaufrufe. Dabei übermittelt Ihr Browser an unser Redaktionssystem (Wix) die aufgerufene Seite, die Herkunft nur als Domain (z. B. „google.com“ oder „direkt“), die Geräteklasse (Handy, Tablet, PC), die Browsersprache, die Bildschirmbreite gerundet und die Ladezeit. Es werden keine IP-Adressen gespeichert, keine Kennungen vergeben und keine Cookies gesetzt; einzelne Personen sind nicht erkennbar. Die Einzeleinträge werden innerhalb weniger Minuten zu Tageszahlen zusammengefasst und gelöscht. Aufrufe von Geräten, auf denen ein Mitglied angemeldet ist, zählen wir nicht mit; wer seine eigenen Aufrufe ebenfalls nicht mitzählen möchte, ruft einmalig <b>spd-soltau.de/?zaehlen=aus</b> auf (rückgängig mit <b>?zaehlen=an</b>). Rechtsgrundlage ist unser berechtigtes Interesse an der Verbesserung der Website (Art. 6 Abs. 1 lit. f DSGVO).</p>
    ...
    <h2>11. Sicherheit und Änderungen</h2>
