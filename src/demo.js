...
export function makeDemoClient(SPD, { rolle = 'vorstand', mitglied = false } = {}) {
  ...
  const data = {
    ...
    Ratsvorbereitung: [
      ...
      { _id: 'demo-r-bau', _owner: ids[1], _createdDate: daysAgo(2), sitzung: inDays(9), typ: 'Ausschuss', b: 'bau', protokoll: ME, gremium: 'Bauausschuss', titel: 'Marktstraße und Radwege', link: 'https://www.soltau.de/', ort: 'Rathaus, Sitzungssaal', zeit: '17:00', tops: [
      ...
      ], von: people[1].name, title: 'Bauausschuss', dokumente: [{ top: '4', titel: 'Vorlage Marktstraße BA 2 (Bürgerinfosystem)', url: 'https://www.soltau.de/' }, { top: '5', titel: 'Bericht Bauausschuss', url: '#ratsarbeit/d-demo-d2' }] },
    ...
    RatAufgaben: (() => {
      ...
      const r = i => ids[5 + i];
      return [
        R(1, 'bau', 'Fragen an die Kämmerei zum Haushalt 2027 schicken', [r(0)], inDays(6)),
        R(2, 'bau', 'Ortsbegehung Marktstraße – Termin finden', [r(1), ME], inDays(10), 'offen', 'Vorschlag: Samstagvormittag.'),
        R(3, 'bau', 'Änderungsantrag „Mehr Bäume in der Marktstraße“ schreiben', [ME], inDays(12), 'offen', 'Antragstext bis Freitag, dann an die Fraktion.'),
        R(4, 'bau', 'Bericht aus dem Ausschuss schreiben', [r(2)], inDays(-1)),
        ...
        R(11, 'feuerschutz', 'Bedarfsplan Feuerwehr: Fragen an die Ortsbrandmeister', [r(3)], inDays(11)),
        R(12, 'kultur', 'Programm Kulturwoche 2027 – Vorschläge sammeln', [r(1), r(5)], inDays(16)),
    ...
    RatDokumente: [
      ...
      { _id: 'demo-d2', _owner: ids[7], _createdDate: daysAgo(4), b: 'bau', kat: 'Bericht', art: 'datei', von: ids[7], vonName: people[7].name, daten: JSON.stringify({ titel: 'Bericht Bauausschuss', name: 'Bericht-Bauausschuss.pdf', typ: 'application/pdf' }), dateiId: '', teile: 0, groesse: 1100000 },
      { _id: 'demo-d3', _owner: ids[5], _createdDate: daysAgo(6), b: 'bau', kat: 'Vorlage', art: 'link', von: ids[5], vonName: people[5].name, daten: JSON.stringify({ titel: 'Vorlage Haushalt 2027 (Bürgerinfosystem)', url: 'https://ris.stadt-soltau.de/bi/infobi.asp' }) },
    ...
    SitzungNotizen: [
      { _id: uid(), _owner: ME, _createdDate: daysAgo(0.05), _updatedDate: daysAgo(0.05), sitzungId: 'demo-r-bau', memberId: ME, name: 'Max Mustermann', title: 'Max Mustermann – Notizen', text: 'TOP 4 – Marktstraße\nNachfragen: Wann kommen die Bäume? Kosten Radspur?\n\nTOP 5\nVariante B – 2,50 m, Asphalt. Beleuchtung?', skizze: '', freigabe: true },
      { _id: uid(), _owner: ids[7], _createdDate: daysAgo(0.04), _updatedDate: daysAgo(0.04), sitzungId: 'demo-r-bau', memberId: ids[7], name: people[7].name, title: 'Notizen', text: 'Verwaltung: Bäume kommen im Frühjahr 2027 (Zusage Bauamt).\nRadspur bleibt – im Protokoll festhalten lassen!', skizze: '', freigabe: true },
      { _id: uid(), _owner: ids[5], _createdDate: daysAgo(0.03), _updatedDate: daysAgo(0.03), sitzungId: 'demo-r-bau', memberId: ids[5], name: people[5].name, title: 'Notizen', text: 'Fürs Video: „Zwölf neue Bäume für die Marktstraße – das war unser Antrag.“', skizze: JSON.stringify([{ farbe: '#0F0F0F', breite: 3, radierer: false, punkte: [[80, 120, 0.5], [180, 60, 0.6], [280, 140, 0.5], [380, 70, 0.6], [480, 130, 0.5]] }, { farbe: '#E3000F', breite: 7, radierer: false, punkte: [[80, 220, 0.5], [520, 230, 0.5]] }]), freigabe: true },
      { _id: uid(), _owner: ids[6], _createdDate: daysAgo(0.02), _updatedDate: daysAgo(0.02), sitzungId: 'demo-r-bau', memberId: ids[6], name: people[6].name, title: 'Notizen', text: 'privat: Termin mit Anwohnern nächste Woche', skizze: '', freigabe: false },
    ],
    SitzungChat: [
      { _id: uid(), _owner: ids[7], _createdDate: daysAgo(0.02), sitzungId: 'demo-r-bau', memberId: ids[7], name: people[7].name, title: 'Chat', daten: JSON.stringify({ text: 'Bin 5 Minuten später – fangt ohne mich an.' }) },
      { _id: uid(), _owner: ids[5], _createdDate: daysAgo(0.015), sitzungId: 'demo-r-bau', memberId: ids[5], name: people[5].name, title: 'Chat', daten: JSON.stringify({ text: 'TOP 4: Verwaltung hat die Radspur eben bestätigt 👍' }) },
      { _id: uid(), _owner: ids[1], _createdDate: daysAgo(0.01), sitzungId: 'demo-r-bau', memberId: ids[1], name: people[1].name, title: 'Chat', daten: JSON.stringify({ text: 'Dann bleiben wir bei dafür.' }) },
    ],
