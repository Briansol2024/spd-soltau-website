...
const RAT = {
  ...
  Postfach: { displayName: 'Post – Nachrichten (je Kopie nur für den Besitzer)', permissions: P('SITE_MEMBER_AUTHOR', 'SITE_MEMBER', 'SITE_MEMBER_AUTHOR', 'SITE_MEMBER_AUTHOR'), fields: [T('richtung', 'Ein/Aus'), T('partnerId', 'Partner-ID'), T('partnerName', 'Partner'), T('text', 'Text'), T('gelesen', 'Gelesen', 'BOOLEAN'), T('zugestellt', 'Zugestellt', 'BOOLEAN'), T('nachrichtId', 'Nachricht-ID'), T('gesendetAm', 'Gesendet')] },
  Kalenderlinks: { displayName: 'Termine – mein Kalender-Abo', permissions: P('SITE_MEMBER_AUTHOR', 'SITE_MEMBER', 'SITE_MEMBER_AUTHOR', 'SITE_MEMBER_AUTHOR'), fields: [T('memberId', 'Mitglieds-ID'), T('schluessel', 'Schlüssel'), T('name', 'Name')] },
