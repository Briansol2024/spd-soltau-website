...
export function makeDemoClient(SPD, { rolle = 'vorstand', mitglied = false } = {}) {
  ...
  const data = {
    ...
    FilmProjekte: [
      { _id: 'demo-fp1', _owner: ME, _createdDate: daysAgo(3), _updatedDate: daysAgo(1), titel: 'Ratssitzung Oktober – Reel', art: 'ratsbericht', status: 'skript', datum: inDays(2), skript: '[INTRO – du in die Kamera]\nMoin Soltau! Ratssitzung – 12 Punkte, 5 Entscheidungen. Das Wichtigste in 45 Sekunden.\n\n[TOP 9 – Marktstraße · Overlay: „Marktstraße: Angenommen 19:10“]\nDie Marktstraße wird saniert – mit unserem Änderungsantrag: zwölf zusätzliche Bäume. Angenommen mit 19 zu 10.', drehplan: 'A1 Rückblick-Kachel als Abschlussbild\nA2 Ratsbericht-Seite scrollen (spd-soltau.de/ratsbericht)', notizen: 'Dreh Donnerstag 18 Uhr im Roten Bahnhof, Birhat spricht TOP 10.', overlays: JSON.stringify([{ typ: 'gross', dauer: 4, werte: { label: 'Ratssitzung 01.10.', text: 'So hat der Rat|*entschieden*', pos: 'oben', gr: 'm' } }, { typ: 'stempel', dauer: 3, werte: { text: 'Angenommen' } }]), ki: '[]', von: 'Max Mustermann', memberId: ME, title: 'Ratssitzung Oktober – Reel' },
