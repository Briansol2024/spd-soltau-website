...
const SCHEMA = {
  ...
  Ratsvorbereitung: [T('b', 'Bereich/Ausschuss'), T('protokoll', 'Ergebnisse trägt ein (ID)'), T('ergebnisNur', 'Nur Sitzungsleitung trägt Ergebnisse ein', 'BOOLEAN'), T('aktuell', 'Aktueller Punkt', 'NUMBER'), T('skript', 'Instagram-Skript'), T('typ', 'Art'), T('gremium', 'Gremium'), T('sitzung', 'Sitzung am'), T('zeit', 'Uhrzeit'), T('ort', 'Ort'), T('titel', 'Titel'), T('link', 'Link'), T('hinweis', 'Hinweis'), T('von', 'Von')],
