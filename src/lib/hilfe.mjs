...
export const HELP_TOPICS = [
  ...
  },
  {
    ...
    intro: 'Alle Termine – oder nur deine Zusagen – automatisch im eigenen Kalender. Neue Termine erscheinen von selbst.',
    steps: {
      android: [
        'Tippe unten auf „Termine“ und wische ganz nach unten zu „Kalender abonnieren“.',
        'Drei Kalender stehen zur Wahl. „Nur meine Zusagen“ richtest du einmal mit einem Tipp ein – darin stehen genau die Termine, bei denen du „Ich komme“ getippt hast.',
        'Tippe auf „Adresse kopieren“.',
        'Jetzt die Google-Besonderheit: Hinzufügen geht nur am Rechner. Öffne calendar.google.com, links bei „Weitere Kalender“ auf „+“ und dann „Per URL“.',
        'Adresse einfügen, „Kalender hinzufügen“ – fertig. Auf dem Handy erscheint er von selbst in der Kalender-App; nur hinzufügen lässt er sich dort nicht.',
      ],
      ios: [
        'Tippe unten auf „Termine“ und wische ganz nach unten zu „Kalender abonnieren“.',
        'Drei Kalender stehen zur Wahl. „Nur meine Zusagen“ richtest du einmal mit einem Tipp ein.',
        'Tippe auf „Abonnieren“. Beim allerersten Mal steht die Datei erst nach dem nächsten Abgleich bereit – spätestens nach einer halben Stunde.',
        'Das iPhone fragt „Kalender abonnieren?“ – tippe auf „Abonnieren“ und dann auf „Fertig“.',
        'Die Termine stehen jetzt in deiner Kalender-App. Sagst du später ab, verschwindet der Termin dort wieder.',
      ],
      windows: [
        'Klicke links auf „Termine“ und scrolle ganz nach unten zu „Kalender abonnieren“.',
        'Drei Kalender stehen zur Wahl. „Nur meine Zusagen“ richtest du einmal mit einem Klick ein.',
        ...
        'Im Google Kalender: calendar.google.com öffnen, „Weitere Kalender“ → „+“ → „Per URL“. Neue Termine laufen dann von selbst mit – auch auf dem Handy.',
      ],
      macos: [
        'Klicke links auf „Termine“ und scrolle ganz nach unten zu „Kalender abonnieren“.',
        'Drei Kalender stehen zur Wahl. „Nur meine Zusagen“ richtest du einmal mit einem Klick ein.',
        'Klicke auf „Abonnieren“ – die Kalender-App öffnet sich.',
        'Bestätige mit „Abonnieren“ und „OK“. Tipp: „Automatisch aktualisieren“ auf „Jede Stunde“ stellen.',
        'Die Termine stehen jetzt im Kalender – mit iCloud auch auf iPhone und iPad. Die Adresse gehört nur dir, bitte nicht weitergeben.',
      ],
    },
  },
  {
  ...
  },
  {
    ...
    steps: { alle: [
      ...
      'Über {mehr} findest du auch „Sitzungen“ – Rat, Ausschüsse, Fraktion und Vorstand.',
