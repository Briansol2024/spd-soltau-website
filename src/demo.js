...
export function makeDemoClient(SPD, { rolle = 'vorstand', mitglied = false } = {}) {
  ...
  const data = {
    ...
    Ratsvorbereitung: [
      ...
      { _id: 'demo-r-stadt', _owner: ids[1], _createdDate: daysAgo(2), sitzung: inDays(9), typ: 'Ausschuss', b: 'stadt', protokoll: ME, gremium: 'Ausschuss Stadtentwicklung', titel: 'Marktstraße und Radwege', link: 'https://www.soltau.de/', ort: 'Rathaus, Sitzungssaal', zeit: '17:00', tops: [
