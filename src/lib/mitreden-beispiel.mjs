...
export function beispielMitreden() {
  return {
    ...
    baustellen: [
      { id: 'k1', titel: 'Marktstraße', art: 'Sperrung', bis: 'Vollsperrung ab März, bis November 2027', was: 'Neues Pflaster, breitere Gehwege, zwölf Bäume, neue Beleuchtung.', warum: 'Ratsbeschluss vom 2. Oktober (19 : 10).', umleitung: 'Über Poststraße und Celler Straße; Geschäfte bleiben zu Fuß erreichbar.', spd: 'Unser Antrag: die zwölf Bäume. Angenommen.', lat: 52.98493, lng: 9.83954, quelle: 'Bekanntmachung der Stadt vom 3.10.' },
      { id: 'k2', titel: 'Winsener Straße', art: 'Baustelle', bis: 'Halbseitig, bis 30. Oktober', was: '180 Meter Abwasserkanal werden erneuert. Ampelregelung.', warum: 'Kanal von 1961, mehrere Rohrbrüche im Frühjahr.', umleitung: 'Bus 104 über Celler Straße.', spd: 'Wir haben nach dem Radweg gefragt: bleibt frei.', lat: 52.99814, lng: 9.85753, quelle: '' },
      { id: 'k3', titel: 'Bahnhofstunnel', art: 'Geplant', bis: 'Beleuchtung, November', was: 'Neue LED-Beleuchtung und Kameras an den Zugängen.', warum: 'Anliegen aus „Was Soltau bewegt“.', umleitung: 'Keine – Arbeiten nachts.', spd: 'Im Haushalt eingeplant.', lat: 52.98787, lng: 9.84631, quelle: '' },
    ],
    umfragen: [
